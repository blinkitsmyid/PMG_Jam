...
public class GameInput : MonoBehaviour
{
    ...
    public event EventHandler OnLampInteract;
    ...
    private void Awake()
    {
        ...
        _playerInputActions.Player.Lamp.performed += Lamp_performed;
        _playerInputActions.Player.Door.performed += Door_performed;
    ...
    private void Lamp_performed(InputAction.CallbackContext obj)
    {
        OnLampInteract?.Invoke(this, EventArgs.Empty);
    }
    private void Door_performed(InputAction.CallbackContext obj)
    {
